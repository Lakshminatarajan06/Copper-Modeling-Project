...
if option=="Selling Price Prediction":
    ...
    with st.form("user_input_form"):
        ...
        if submitted:
            ...
            if customer and thickness and width and Quantity:
                ...
                with open(r'C:\Users\Good Day\Desktop\Project 5\price1_model.pkl', 'rb') as file:
                ...
                with open('scaler_price.pkl', 'rb') as file:
                    scale=pickle.load(file)
                # st.write(user_input_data)
                user_input_data=scale.transform(user_input_data)
                ...
                # Extracting the selling price from array
                selling_price=round(selling_price[0],2)

                # Display the predicted selling price
                st.write(f"**The predicted selling price is: {selling_price}**")

            else:
                st.warning("**Please fill the data in all fields**")
...
if option=="Status Prediction":
    ...
    with st.form("price"):
        ...
        if submitted:
            ...
            if customer and thickness and width and Quantity and selling:

                item_type_map={'W':1, 'WI':2, 'S':3, 'Others':4, 'PL':5, 'IPL':6, 'SLAWR':7}
                # status_map= {'Won':1, 'Draft':2, 'To be approved':3, 'Lost':4, 'Not lost for AM':5,
                #             'Wonderful':6, 'Revised':7, 'Offered':8, 'Offerable':9}

                with open(r'C:\Users\Good Day\Desktop\Project 5\status_model.pkl', 'rb') as file:
                    model=pickle.load(file)
                ...
                with open('scale_.pkl', 'rb') as file:
                    scale=pickle.load(file)
